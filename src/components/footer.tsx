...
import mhsPdf from "../assets/pdf/mhs.pdf"
            ...
            <div className="mx-auto w-full max-w-6xl  p-4 py-6 lg:py-8">
                <div className="sm:flex sm:justify-between  my-12 sm:my-20">
                    ...
                    <div>
                        <div className="grid grid-cols-1 gap-8 sm:gap-12 sm:grid-cols-2">
                            <div>
                                ...
                                <ul className="text-gray-500  font-medium">
                                    <li className="mb-2">
                                        Jaipur-Bikaner Bypass, <br /> Gokulpura, Sikar
                                    </li>
                                    <li className='mb-2'>
                                        1800-01572-299
                                    </li>
                                    ...
                                    <li className='mb-2'>
                                        <div className="flex mt-4  sm:mt-0 p-2">
                                            ...
                                            <a href="#" className="text-gray-500 hover:text-gray-900  ms-5 bg-white rounded-full p-2">
                                                <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#7B057B" viewBox="0 0 21 16">
                                            ...
                                            <a href="#" className="text-gray-500 hover:text-gray-900  ms-5 bg-white rounded-full p-2">
                                                <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#7B057B" viewBox="0 0 20 17">
                                                    <path fill-rule="evenodd" d="M20 1.892a8.178 8.178 0 0 1-2.355.635 4.074 4.074 0 0 0 1.8-2.235 8.344 8.344 0 0 1-2.605.98A4.13 4.13 0 0 0 13.85 0a4.068 4.068 0 0 0-4.1 4.038 4 4 0 0 0 .105.919A11.705 11.705 0 0 1 1.4.734a4.006 4.006 0 0 0 1.268 5.392 4.165 4.165 0 0 1-1.859-.5v.05A4.057 4.057 0 0 0 4.1 9.635a4.19 4.19 0 0 1-1.856.07 4.108 4.108 0 0 0 3.831 2.807A8.36 8.36 0 0 1 0 14.184 11.732 11.732 0 0 0 6.291 16 11.502 11.502 0 0 0 17.964 4.5c0-.177 0-.35-.012-.523A8.143 8.143 0 0 0 20 1.892Z" clip-rule="evenodd" />
                                                </svg>
                                                <span className="sr-only">Twitter page</span>
                                            </a>
                                            <a href="#" className="text-gray-500 hover:text-gray-900  ms-5 bg-white rounded-full p-2">
                                                <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#7B057B" viewBox="0 0 20 20">
                        ...
                        <div className='grid grid-cols-1 gap-8 sm:gap-12 sm:grid-cols-2 '>
                            <div onClick={toggleModal} className=' cursor-pointer bg-[#B508B5] text-white rounded-full px-6 py-2 text-sm flex gap-3 items-center'>
                                <img className='h-6' src={prospectus} alt="prospectus" />
                                <p>Download Prospectus</p>
                            </div>
                            <div className='bg-[#B508B5] text-white rounded-full px-6 py-3 text-sm flex gap-3 items-center'>
                ...
                <div className="sm:flex sm:items-center sm:justify-center">
                    <span className="text-sm text-white sm:text-center opacity-60">
                        © Copyright {new Date().getFullYear()} Matrix School Junior Sikar – All Rights Reserved
                    </span>

                </div>
            </div>
            <PDFView pdfVisible={pdfVisible} onClose={toggleModal} mhs={mhsPdf} />
        </footer>
